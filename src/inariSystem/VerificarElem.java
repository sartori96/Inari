...
public class VerificarElem {
	...
	public VerificarElem(float ferro, float magnesio, float nitrogenio, float enxofre, float pentoxidodefosforo,
			float k2o, float calcio, float boro, float cloro, float molibdenio, float cobre, float manganes,
			float zinco, float aluminio, float potassio, float fosforo) {
		super();
		this.ferro = ferro;
